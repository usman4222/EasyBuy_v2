    ...
    return (
        <div className="text-xl text-gray-700 font-semibold flex flex-wrap justify-evenly gap-3 py-10">
            <div className='bg-white p-16 rounded-full w-24 h-24 flex flex-col items-center justify-center'>
                <span className="text-primaryRed font-semibold text-[32px] leading-[33px]">{timeRemaining.days}</span>
                <p className='text-center'>Days</p>
            </div>
            <div className='bg-white p-16 rounded-full w-24 h-24 flex flex-col items-center justify-center'>
                <span className="text-primaryRed font-semibold text-[32px] leading-[33px]">{timeRemaining.hours}</span>
                <p className='text-center'>Hours</p>
            </div>
            <div className='bg-white p-16 rounded-full w-24 h-24 flex flex-col items-center justify-center'>
                <span className="text-primaryRed font-semibold text-[32px] leading-[33px]">{timeRemaining.minutes}</span>
                <p className='text-center'>Mins</p>
            </div>
            <div className='bg-white p-16 rounded-full w-24 h-24 flex flex-col items-center justify-center'>
                <span className="text-primaryRed font-semibold text-[32px] leading-[33px]">{timeRemaining.seconds}</span>
