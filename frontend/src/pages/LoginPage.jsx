            ...
            <section class="bg-white min-h-screen flex items-center justify-center">
                <div class="bg-white flex rounded-2xl shadow-xl max-w-3xl p-5 items-center">
                    <div class="md:w-1/2 px-8 md:px-16">
                        <h2 class="font-bold text-2xl text-customGray">Login</h2>
                        <p class="text-xs mt-4 text-black">If you are already a member, easily log in</p>

                        <form action="" class="flex flex-col gap-4">
                            <input class="p-2 mt-8 rounded-xl border focus:outline-none" type="email" name="email" placeholder="Email" />
                            <div class="relative">
                            ...
                            <button class="bg-primaryRed rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
                        </form>
                        ...
                        <div class="mt-5 text-xs border-b border-primaryRed py-4 text-black hover:text-gray-400">
                    ...
                    <div class="md:block hidden w-1/2">
                        <img class="rounded-2xl" src={loginImage} />
                    </div>
                </div>
            </section>
        </div>
